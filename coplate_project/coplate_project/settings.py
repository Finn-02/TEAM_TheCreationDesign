...
SECRET_KEY = "django-insecure-j@z^we&py)do0!$k%w&_t1=ic7=!jef_^=+bb^y439bylu*h5%"
...
ACCOUNT_AUTHENTICATION_METHOD = "email" # 아이디를 이메일로 사용, username_email은 이름과 이메일 모두 사용
ACCOUNT_EMAIL_REQUIRED = True # 이메일 필수
ACCOUNT_UNIQUE_USERNAME = True
ACCOUNT_USERNAME_REQUIRED = True  # usename 삭제
ACCOUNT_SIGNUP_FORM_CLASS = 'coplate.forms.SignupForm'
ACCOUNT_SESSION_REMEMBER = True # 로그인 상태 유지
ACCOUNT_PASSWORD_INPUT_RENDER_VALUE = True # 비밀번호 입력시 *로 표시
ACCOUNT_CONFIRM_EMAIL_ON_GET = True # 이메일 인증
...
# ACCOUNT_EMAIL_VALIDATION = "optional" # 이메일 검증
# SESSION_COOKIE_AGE = 3600 # 로그인 상태 유지 시간 3600초
